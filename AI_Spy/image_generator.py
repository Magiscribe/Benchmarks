...
import numpy as np
from config import STANDARD_FONT_SIZES, CHARS_PER_ROW, VERTICAL_SPACING, IMAGE_WIDTH, IMAGE_HEIGHT, FONTS, ALPHABET
...
class EyeChartGenerator:
    def __init__(self, output_dir="test_images"):
        ...
        # Create font-specific subdirectories
    ...
    def create_eye_chart(self, font_name, chars_per_row=CHARS_PER_ROW, 
        ...
        # Save to the font-specific directory
        font_dir = os.path.join(self.output_dir, font_name.replace(' ', '_'))
