...
def process_responses():
    ...
    for response_file in os.listdir(responses_dir):
        if response_file.endswith("_responses.json"):
            ...
            for response in responses:
                ...
                predicted_squares = response['responses']
                
                # Process each square (0-4)
    ...
    # Save results
    output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "Results", "Coordinate_Grid_model_results.csv")
